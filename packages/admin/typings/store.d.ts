...
export type RootReducer = {
  ...
  [cst.MODULE_GLOBAL]: {};
  [cst.MODULE_DEFAULT]: {};
} & { [key in keyof Models]: Models[key]['reducer'] extends IAnyFnInObj ? ReducerType<Models[key]['reducer']> : {} };
...
export type RootComputed = {
  ...
  [cst.MODULE_GLOBAL]: {};
  [cst.MODULE_DEFAULT]: {};
} & { [key in keyof Models]: Models[key]['computed'] extends IAnyFnInObj ? ComputedValType<Models[key]['computed']> : {} };
...
export type CtxM<P = {}, M extends Modules = MODULE_DEFAULT, Se = {}, RefCu = {}>
  = ICtx<RootState, RootReducer, RootComputed, P, {}, M, MODULE_VOID, Se, RefCu>;

/** 属于某个模块，扩展了私有状态时 CtxMS<P, M, St, Se, RefCu>*/
export type CtxMS<P = {}, M extends Modules = MODULE_DEFAULT, St = {}, Se = {}, RefCu = {}>
  = ICtx<RootState, RootReducer, RootComputed, P, St, M, MODULE_VOID, Se, RefCu>;
...
export type CtxConn<P = {}, Conn extends Modules = MODULE_VOID, Se = {}, RefCu = {}>
  = ICtx<RootState, RootReducer, RootComputed, P, {}, MODULE_DEFAULT, Conn, Se, RefCu>;
